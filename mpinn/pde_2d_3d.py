...
def heat_equation_2d(
    model, points_with_time: jnp.ndarray, phys: Any | None = None
) -> float:
    """
...
def convection_diffusion_2d(
    model, points: jnp.ndarray, phys: Any | None = None
) -> float:
    """
...
def variable_coefficient_laplacian(
    model, points: jnp.ndarray, conductivity_fn: Callable
) -> float:
    """
